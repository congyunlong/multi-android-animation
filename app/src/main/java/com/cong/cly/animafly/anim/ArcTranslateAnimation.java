package com.cong.cly.animafly.anim;
...
//		mControl = new PointF(mFromXDelta, mToYDelta); // How to choose the
	...
	/**
	 * Calculate the position check_turn_on a quadratic bezier curve by given three points
	...
	public void setControl(PointF mControl) {
